...
<ul
	...
	<!-- Nav Item - Dashboard -->
	<li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath }/adminMainPage">
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		aria-controls="collapseTwo"> <i class="fas fa-fw fa-cog"></i> <span>영화관리</span>
	</a>
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
			...
			<div class="bg-white py-2 collapse-inner rounded">
			    ...
			    <a class="collapse-item" href="adminSchedulesPage">스케줄관리</a>
			     <a class="collapse-item" href="adminAddSchedules">스케쥴추가</a>
			</div>
		</div></li>
